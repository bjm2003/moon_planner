...
int main() {
  ...
  PlanningScenario scenario = reader.Read("scenarios/slope_region.yaml");
  ...
  PlanningResult result = planner.Plan(scenario.request, scenario.occupancy, &scenario.elevation);
